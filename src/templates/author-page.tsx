...
import { IAuthor, IRenderArticles, IRenderProject } from "../types/templates";

const RenderArticles: React.FC<IRenderArticles> = ({ element, index }) => (
  <div
...
const RenderProject: React.FC<IRenderProject> = ({
  title,
  description,
  authors,
  year,
...
const Author: React.FC<IAuthor> = ({ data, location, uri }) => {
                        ...
                        <p>
                          ...
                          memberDetails.social.email ? (
                            <OverlayTrigger
                              ...
                              overlay={(props) => (
                                <Tooltip id="member-details-social-email" {...props}>
                                  {memberDetails.social.email
                                    .replace("@", " [at] ")
                                    .split(".")
                                    .join(" [dot] ")}
                  ...
                  >
                    <div className="card-body">
                      ...
                      {memberArticles.nodes.map((article, ind) => (
                        <RenderArticles element={article} key={ind} index={undefined} />
                      ))}
                    </div>
                  </div>
